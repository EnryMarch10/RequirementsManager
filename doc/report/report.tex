...
$$
\forall \ t_1, t_2 \in r : t_1[X] = t_2[Y] \Rightarrow t_1[Y] = t_2[Y]
$$
...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item Every relation can reach this level after modifies of splitting or merging.
    \end{enumerate}
    ...
    \begin{enumerate}
        ...
        \item Some relationships cannot reach this level even after modifies of splitting or merging.
    \end{enumerate}
\end{enumerate}
